	...
	<table style="text-align: center;">
		<tr>
			<td><a href="#" class="open"><img
					src="../img/menuImg/blended_그린티블렌.jpg" height="200px" width="200px"><br>그린티
					블렌디드<br>5500원</a></td>
			<td>
				<div class="popup">
					<h2>옵션 선택</h2>
						...
						<table class="option">
							...
							<tr>
								...
								<td><input type="button" id="list3_1" value="-"
									name="minus"> <input type="text" id="list3_2" value="0"
									name="quantity" style="text-align: center;" readonly="readonly">
									<input type="button" value="+" name="plus"></td>
							</tr>
							<tr>
								<th><label for="list4">타입</label></th>
								<td><input type="radio" id="list4_1" value="HOT" name="HOT">
									<input type="radio" id="list4_2" value="ICE" name="ICE"></td>
							</tr>
						</table>
					</div>
