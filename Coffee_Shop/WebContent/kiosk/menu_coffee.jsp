	...
	<div class="container-fluid text-center">
		...
		<div class="row content">
			<div class="col-sm-9" align="center">
					...
					<tbody>
						<tr>
							<td><img src="../img/menuImg/espresso_아메리카노.jpg" height="200px"
								width="200px"><br>아메리카노<br>3000원</td>
							<td><img src="../img/menuImg/espresso_에스프레소.jpg" height="200px"
								width="200px"><br>에스프레소<br>4000원</td>
							
						</tr>
						<tr>
							<td><img src="../img/menuImg/espresso_카라멜 마키아토.jpg" height="200px"
								width="200px"><br>카라멜 마키아토<br>5000원</td>
							<td><img src="../img/menuImg/espresso_토피넛.jpg" height="200px"
								width="200px"><br>토피넛<br>5000원</td>
						</tr>
					</tbody>
				...
				<!-- <p class="coffee_menu">
					<img src="../img/menuImg/espresso_아메리카노.jpg"><br>아메리카노 4000원
					<img src="../img/menuImg/espresso_에스프레소.jpg"><br>에스프레소 3000원
				</p>
				<p class="coffee_menu">
					<img src="../img/menuImg/espresso_카라멜 마키아토.jpg"><br>카라멜 마키아토 5000원
