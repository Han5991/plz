...
<body style="background: white">
	...
	<div id="tabCont01" class="tabConts">
		<ul class="menuProduct">
			...
			try {
				stmt = con.prepareStatement("SELECT * FROM menu WHERE filename LIKE 'e%' ORDER BY filename asc");
			...
			File file = new File("C:\\Users\\admin\\git\\plz\\Coffee_Shop\\WebContent\\img\\menuImg\\espresso");
			...
			%><li class="list">
				<p class="img">
					<img alt="<%=f.getName()%>"
						src="../img/menuImg/espresso/<%=f.getName()%>" width="250"
						height="250" /><br>
				</p>
