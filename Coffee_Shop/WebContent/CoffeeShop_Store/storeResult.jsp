...
.store_list{overflow:hidden;width:70%;padding:0 10px 10px; margin:0 auto; text-align:center;}
...
<body style="background: lightgray">
   ...
   <div class="jumbotron" style="background-color: white;">
      <div class="container text-center">
         <form action="storeResult.jsp" method="post" name="search">
			<input type="text" placeholder="매장명 검색" id="search_shop" name="search_shop" size="10"
				class="form-control">
   ...
   <div class="jumbotron" style="background-color: white;">
      ...
      <table class="store_list" border="0">
      	<tr>
			<td><span style="margin-left:10px"><strong>매장 이름</strong></span></td>
...
%>			
      	<tr>
			...
			<td> <form action="#" method= "post"><input type="hidden" value="<%=dto.getStoreId() %>"><button type="submit" class="btn btn-warning">선택</button></form></td>			
      	</tr>    
<%
}
%>	  	
